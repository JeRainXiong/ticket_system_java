...
<div style="min-height: 600px;background-color: #F4F5F9 ;padding-top:30px">
  <div class="page_pay container">
    ...
    <div class="box-main-top-right fr">
        <p class="money">应付总金额：<span class="num">${totalMoney}</span><span>元</span></p>
    </div>
    <div class="box-main-top-left ">
        <h3>订单提交成功！去付款咯~</h3>
        <p class="mt-30"><span>收货信息：</span><span class="mr-10">${name}</span>
            <span class="mr-10">${tel}</span>&nbsp;
    ...
    <div class="box-main-bot-left">
        <h3>订单详情</h3>
        <p class="box-content-text mt-10">订单号：<span>${orderId}</span></p>
        <p class="box-content-text">票品信息： <span>${concertName}</span></p>
        <p class="box-content-text">演出场次：<span>${concertTime}</span></p>
        <p class="box-content-text">票面价格：<span>${ticketPrice}</span></p>
